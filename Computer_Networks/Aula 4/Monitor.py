...
def recebeComando(s):
    ...
    while True:
        ...
        try:
            (comando, dado) = strdata.split(' ',1) # Separa uma string em duas partes comando e dado. 
                                                   # EX: Registro Sala. Registro -> comando Sala -> dado
        except:
        ...
        if comando == 'REGISTRO':
            ...
            if addr not in SENSORES.values(): # Verifica se o sensor esta registrado para executar o comando
                ID = 'DESCONHECIDO'
